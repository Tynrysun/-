          ...
          {groupedRules.map((group, groupIndex) => {
            ...
            return (
              <div key={groupIndex} className="space-y-4">
                {/* Group Header */}
                <div 
                  className="flex items-center gap-3 cursor-pointer group select-none sticky top-0 bg-slate-50/95 backdrop-blur-sm py-2 z-10 rounded-lg pl-2 transition-colors hover:bg-slate-100/50"
